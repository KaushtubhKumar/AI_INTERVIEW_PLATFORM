...
//     role,type,techstack,createdAt}:InterviewCardProps) => {
...
//             <div className='flex flex-row gap-2'>
//                 <Image src="/calendar.svg" alt="calender" height={22}
//                 width={22}/>
//                 <p>{formatedDate}</p>
//             </div>
...
//                 {feedback?.finalAssessment || 'You havent taken the interview yet.Take it now.'}
//              </p>
